...
class TstAppABC(ABC):
    ...
    def _inspect_ssn_table(self, persistent_stack: PersistentStack, persistent_stack_template: Template):
        ...
        disaster_recovery_role_logical_id = persistent_stack.get_logical_id(
            persistent_stack.ssn_table.disaster_recovery_role.node.default_child
        )
                    ...
                    'Condition': {
                        'StringNotEquals': {
                            'aws:PrincipalArn': [
                                ...
                                {'Fn::GetAtt': [disaster_recovery_role_logical_id, 'Arn']},
