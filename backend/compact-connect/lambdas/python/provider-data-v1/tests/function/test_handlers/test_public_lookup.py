...
class TestPublicGetProvider(TstFunction):
    ...
    def test_public_get_provider_response_with_expected_fields_filtered(self):
        ...
        with open('../common/tests/resources/api/provider-detail-response.json') as f:
            ...
            expected_provider['licenses'][0].pop('homeAddressStreet1')
            expected_provider['licenses'][0].pop('homeAddressStreet2')
            expected_provider['licenses'][0].pop('homeAddressCity')
            expected_provider['licenses'][0].pop('homeAddressState')
            expected_provider['licenses'][0].pop('homeAddressPostalCode')
            expected_provider['licenses'][0].pop('emailAddress')
            expected_provider['licenses'][0].pop('phoneNumber')
            expected_provider['licenses'][0].pop('militaryWaiver')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('ssnLastFour')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('dateOfBirth')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('homeAddressStreet1')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('homeAddressStreet2')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('homeAddressCity')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('homeAddressState')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('homeAddressPostalCode')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('emailAddress')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('phoneNumber')
            expected_provider['licenses'][0]['history'][0]['previous'].pop('militaryWaiver')
