...
class TestMilitaryAudit(TstFunction):
    ...
    def _when_testing_military_audit(self, military_status: str, military_status_note: str | None = None):
    ...
    def test_military_audit_updates_provider_record(self):
        ...
        updated_provider_record = self._provider_table.get_item(
            Key={
                'pk': f'{test_provider.compact}#PROVIDER#{test_provider.providerId}',
                'sk': f'{test_provider.compact}#PROVIDER',
            }
        )['Item']

        loaded_provider = ProviderData.from_database_record(updated_provider_record)

        self.assertEqual('approved', loaded_provider.militaryStatus)
        self.assertEqual('', loaded_provider.militaryStatusNote)
    ...
    def test_military_audit_declined_updates_with_note(self):
        ...
        self.assertEqual('declined', loaded_provider.militaryStatus)
        self.assertEqual('Invalid documentation', loaded_provider.militaryStatusNote)
    ...
    def test_military_audit_invalid_status_returns_400(self):
        ...
        test_event = self.test_data_generator.generate_test_api_event(
            ...
            value_overrides={
                ...
                'body': json.dumps({'militaryStatus': 'invalid_status'}),
            },
        )
