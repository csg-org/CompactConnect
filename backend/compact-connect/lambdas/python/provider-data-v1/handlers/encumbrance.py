...
from cc_common.data_model.schema.common import AdverseActionAgainstEnum, ClinicalPrivilegeActionCategory
...
def _generate_adverse_action_for_record_type(event: dict,
                                             adverse_action_against_record_type: AdverseActionAgainstEnum) -> AdverseActionData:
