...
class TestCopyRecords(TstFunction):
        ...
        self.assertEqual(
            {
                ...
                'copiedCount': 1000,
                'copyLastEvaluatedKey': 'eyJwayI6ICIxODk4IiwgInNrIjogIjE4OTgifQ==',
                'sourceTableArn': self.mock_source_table_arn,
                'destinationTableArn': self.mock_destination_table_arn,
                'tableNameRecoveryConfirmation': self.mock_destination_table_name,
            },
    ...
    def test_copy_records_uses_pagination_key_if_provided(self):
        ...
        event['copyLastEvaluatedKey'] = 'eyJwayI6ICIxODk4IiwgInNrIjogIjE4OTgifQ=='
        event['copiedCount'] = 1000
        ...
        self.assertEqual(
            {
                'copyStatus': 'COMPLETE',
                # the 1000 that is passed into the event should be added to the remaining 4900 that get copied over
                'copiedCount': 5000,
                'sourceTableArn': self.mock_source_table_arn,
                'destinationTableArn': self.mock_destination_table_arn,
                'tableNameRecoveryConfirmation': self.mock_destination_table_name,
