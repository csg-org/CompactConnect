...
1. **Create the Archived Record**
   ...
   - Update the item pk with the following structure:
     ...
     - **Remove field**: `famGiv`. If this field is not removed from the record, the user will continue to show up in the list of staff users in the UI, since we use this field in the index used to lookup the list of staff users.
