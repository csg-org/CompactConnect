...
def get_cognito_details(user_pool_id):
    ...
    try:
        ...
        client_id = client_response["UserPoolClients"][0]["ClientId"] if client_response["UserPoolClients"] else "No Client ID Found"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--as-frontend-env", action="store_true", help="Output in .env format as expected by frontend")
