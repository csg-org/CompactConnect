...
TEST_DIRS = (
    'lambdas/python/common',
    'lambdas/python/cognito-backup',
    'lambdas/python/compact-configuration',
    'lambdas/python/custom-resources',
    'lambdas/python/data-events',
...
def get_coverage():
    ...
    return Coverage(
        config_file=APP_DIR / '.coveragerc',
...
def main():
    ...
    if args.report:
        ...
        if args.open_report:
            ...
            report_path = APP_DIR / 'coverage' / 'index.html'
