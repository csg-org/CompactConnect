...
class UIDistribution(Distribution):
    def __init__(self, scope: Construct, construct_id: str, *, ui_bucket: IBucket, persistent_stack: PersistentStack):
        ...
        web_acl = WebACL(scope, 'DistributionAcl', acl_scope=WebACLScope.CLOUDFRONT, enable_acl_logging=True)
