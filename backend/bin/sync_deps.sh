pip-sync \
  ...
  compact-connect/lambdas/python/delete-objects/requirements-dev.txt \
  compact-connect/lambdas/python/delete-objects/requirements.txt \
  compact-connect/lambdas/python/license-data/requirements-dev.txt \
  compact-connect/lambdas/python/license-data/requirements.txt \
