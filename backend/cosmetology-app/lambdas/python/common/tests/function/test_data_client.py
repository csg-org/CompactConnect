...
class TestDataClient(TstFunction):
    ...
    def test_deactivate_privilege_updates_record(self):
        ...
        self.assertEqual(
            {
                'pk': f'aslp#PROVIDER#{provider_id}',
                'sk': 'aslp#UPDATE#1#privilege/ne/aud/2024-11-08T23:59:59+00:00/250e8629a6b21e5939af5f36939328e0',
    ...
    def test_deactivate_privilege_on_inactive_privilege_raises_exception(self):
        ...
        original_history = {
            'pk': f'aslp#PROVIDER#{provider_id}',
            'sk': 'aslp#UPDATE#1#privilege/ne/aud/2024-11-08T23:59:59+00:00/b581f52749608fa7aeb0c8ca2565a78a',
            'type': 'privilegeUpdate',
            'updateType': 'renewal',
            'providerId': str(provider_id),
            'compact': 'aslp',
