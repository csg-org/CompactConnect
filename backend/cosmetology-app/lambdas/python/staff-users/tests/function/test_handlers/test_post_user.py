...
class TestPostUser(TstFunction):
    ...
    def test_post_user_rejects_permissions_for_compact_other_than_path_compact(self):
        ...
        # api_user already requests cosm permissions; add a second, mismatched compact key.
        ...
        self.assertEqual(
            {'message': "Requested permissions for compact 'aslp' do not match the path compact 'cosm'."}, body
        )
