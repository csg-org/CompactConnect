...
DUPLICATE_LICENSE_NUMBER_ERROR_MESSAGE = (
    'Same license number, license type, and license scope detected on multiple rows. License number '
    'matches with record {matched_record}. Every record must have a unique license number per license '
