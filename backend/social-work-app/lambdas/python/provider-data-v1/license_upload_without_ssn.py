...
DUPLICATE_LICENSE_NUMBER_ERROR_MESSAGE = (
    'Same license number, license type, and license scope detected on multiple rows. Every record must '
    'have a unique license number per license type and scope within the same {scope}.'
)
