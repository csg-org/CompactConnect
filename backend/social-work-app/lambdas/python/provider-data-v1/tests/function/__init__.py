        ...
        for name_idx, ssn_serial in enumerate(range(start_serial, start_serial - 10, -1)):
            ...
            with patch(
                ...
                **patch_kwargs,
                ...
                provider_id = self._ssn_table.get_item(Key={'pk': f'socw#SSN#{ssn}', 'sk': f'socw#SSN#{ssn}'})['Item'][
                    'providerId'
                ]
