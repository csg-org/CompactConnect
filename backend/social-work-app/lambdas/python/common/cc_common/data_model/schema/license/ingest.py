...
class LicenseIngestSchema(LicenseCommonSchema):
    ...
    # provider id. Its presence triggers an SSN-correction migration in the ingest handler, and also
    # suppresses CUID assignment for that upload; it is popped before the license record is persisted.
