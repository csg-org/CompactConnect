...
class authorize_compact:  # noqa: N801 invalid-name
    ...
    (i.e. socw/write or oh/socw.write).
    """
...
def _authorize_compact_with_scope(event: dict, resource_parameter: str, scope_parameter: str, action: str) -> None:
    ...
    i.e. socw/readGeneral would allow read access to all generally available jurisdiction data within the socw compact.

    Write - granted at jurisdiction level, allows write access to a specific jurisdiction within the compact.
    i.e. oh/socw.write would allow write access to the ohio jurisdiction within the socw compact.
    ...
    i.e. 'socw/admin' would allow administrative access to the socw compact. 'oh/socw.admin' would allow
