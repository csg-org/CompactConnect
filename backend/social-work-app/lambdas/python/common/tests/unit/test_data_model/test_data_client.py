...
class TestDataClient(TstLambdas):
    ...
    def test_get_or_create_provider_id_existing(self):
        ...
        # Call the method
        provider_id = self.client.get_or_create_provider_id(compact='socw', ssn='123456789')
    ...
    def test_get_provider_not_found(self):
        ...
        with self.assertRaises(CCNotFoundException):
            self.client.get_provider(compact='socw', provider_id='test_id', detail=True, consistent_read=False)
