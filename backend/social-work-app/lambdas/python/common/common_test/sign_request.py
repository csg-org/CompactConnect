"""
Client Reference Implementation for Signature Request Signing

This module provides a validated reference implementation for signing API requests
using ECDSA with SHA-256 as required by the CompactConnect signature authentication system.
...
def sign_request(
    ...
    how to properly sign requests for the CompactConnect signature authentication system.
    ...
    :param path: Request path (e.g., '/v1/compacts/socw/jurisdictions/al/providers/query')
