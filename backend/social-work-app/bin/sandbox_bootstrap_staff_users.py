...
if __name__ == '__main__':
    ...
    bootstrap_board_ed_user(compact='socw', jurisdiction='oh', email_username=email_username, email_domain=email_domain)
    bootstrap_compact_ed_user(compact='socw', email_username=email_username, email_domain=email_domain)
