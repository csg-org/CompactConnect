...
class TestBasePipelineStack(TestCase):
    def setUp(self):
    ...
    def test_creates_frontend_pipeline_stack(self):
        ...
        # Use beta context for this test
        context = get_beta_context('frontend')
        ...
        # Verify stack has expected attributes
        self.assertEqual(pipeline_stack.environment_name, BETA_ENVIRONMENT_NAME)
    ...
    def test_create_predictable_pipeline_role_frontend(self):
        ...
        # Use frontend context for frontend pipeline type
