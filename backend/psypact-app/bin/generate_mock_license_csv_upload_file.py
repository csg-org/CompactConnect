...
# bin/generate_mock_license_csv_upload_file.py --count 100 --compact psypact --jurisdiction ne --format csv
# bin/generate_mock_license_csv_upload_file.py --count 100 --compact psypact --jurisdiction ne --format json
import json
import os
import sys
