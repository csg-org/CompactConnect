...
import Pagination from '@components/Lists/PaginationLegacy/PaginationLegacy.vue';
...
describe('Pagination component', async () => {
    ...
    it('should load with expected default behavior', async () => {
        ...
        expect(spy.withArgs({ firstIndex: 0, lastIndexExclusive: 25, prevNext: 0 }).calledOnce).to.be.true;
