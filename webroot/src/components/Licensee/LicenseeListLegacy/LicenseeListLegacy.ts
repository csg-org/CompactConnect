...
import LicenseeSearch, { LicenseSearchLegacy } from '@components/Licensee/LicenseeSearchLegacy/LicenseeSearchLegacy.vue';
...
class LicenseeList extends Vue {
    ...
    get searchParams(): LicenseSearchLegacy {
    ...
    handleSearch(params: LicenseSearchLegacy): void {
